        ...
        <div className="grid grid-cols-3 gap-6 mb-6">
          ...
          <section className="bg-white rounded-2xl p-6 border border-black/10">
            ...
            <div className="text-center py-4">
              ...
              <p className="font-bold text-gray-700 text-sm">Active registrations</p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl p-6 border border-black/10">
            ...
            <div className="text-center py-4">
              ...
              <p className="font-bold text-gray-700 text-sm">Verified professionals</p>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl p-6 border border-black/10">
            ...
            <div className="text-center py-2">
              ...
              <p className="font-bold text-gray-700 text-sm mb-4">New applications</p>
              <button
        ...
        <section className="bg-white rounded-2xl p-8 border border-black/10 mb-6">
          ...
          <div className="relative">
            <svg viewBox="0 0 800 200" className="w-full h-48">
              <line x1="0" y1="40" x2="800" y2="40" stroke="#f3f4f6" strokeWidth="1"/>
              <line x1="0" y1="80" x2="800" y2="80" stroke="#f3f4f6" strokeWidth="1"/>
              <line x1="0" y1="120" x2="800" y2="120" stroke="#f3f4f6" strokeWidth="1"/>
              <line x1="0" y1="160" x2="800" y2="160" stroke="#f3f4f6" strokeWidth="1"/>
          ...
          <div className="flex justify-center gap-8 mt-6 pt-6 border-t border-gray-100">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-gray-700">Student Registrations</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-4 h-4 rounded-full bg-indigo-600"></span>
              <span className="text-sm font-bold text-gray-700">Session Bookings</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-4 h-4 rounded-full bg-green-500"></span>
              <span className="text-sm font-bold text-gray-700">Community Posts</span>
            </div>
          </div>
        </section>
