...
const StudentSidebar = ({ user }) => {
  ...
  const navItems = [
    ...
    { path: "/counselors", label: "Find Counselor", icon: Search },
    { path: "/mood-quiz", label: "Weekly Mood Quiz", icon: ClipboardList },
    { path: "/community-forum", label: "Community Forum", icon: MessageSquare },
    { path: "/my-sessions", label: "My Sessions", icon: CalendarDays },
